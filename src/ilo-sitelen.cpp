...
std::unordered_map<char, std::string> punctuation = {
    {' ', " "}, {':', "\U000F199D"}, {'.', "\U000F199C"}, {'!', "\U0000FF01"},
    {'"', "\""}, {'$', "$"}, {'%', "%"}, {'^', "^"},
    {'&', "&"}, {'*', "\U000F1995"}, {'(', "\U000F1997"}, {')', "\U000F1998"},
    {'-', "\U0000200D"}, {'=', "\U000F1992"}, {'_', "\U000f1999"}, {'+', "\U000F1996"},
    {'[', "\U000F1990"}, {']', "\U000F1991"}, {'{', "\U000F199A"}, {'}', "\U000F199B"},
    {';', ";"}, {'\'', "\'"}, {'#', "#"}, {'@', "@"},
    {'~', "~"}, {',', ","}, {'<', "\U0000300C"}, {'>', "\U0000300D"},
    {'/', "\U0000FE00"}, {'?', "\U0000FF1F"}, {'\\', "\U0000FE01"}, {'|', "|"},
};
